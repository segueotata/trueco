...
const data = [
	{
		id: 1,
		img: "public/assets/images/5.png",
	...
	{
		id: 2,
		img: "public/assets/images/2.png",
	...
	{
		id: 3,
		img: "public/assets/images/4.png",
...
» Uso de selos e certificações sem credibilidade.`,
	...
	{
		id: 4,
		img: "public/assets/images/7.png",
	...
	{
		id: 5,
		img: "public/assets/images/8.png",
	...
	return (
		<>
			<Box sx={{ mx: "1em" }}>
				<Typography
					variant="h4"
					sx={{ textAlign: "center", my: "1em" }}
				>
					Leia um pouco mais sobre o greenwashing
				</Typography>
				<Box
					sx={{
						my: "1em",
